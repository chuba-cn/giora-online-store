      ...
      <div className="grid grid-cols-2 space-x-5 w-full">
        ...
        {totalProducts > 0 ? (
          ...
          <div className="flex flex-col justify-center items-center gap-5 text-center">
            <p className="text-3xl text-texts-normal font-bold mb-4">Your cart is empty</p>
            <Button onClick={() => router.push("/")} className="text-[1rem] font-nunitosans border border-green-primary-normal rounded-md p-4 hover:bg-green-primary-light bg-white text-green-primary-normal mb-5">
              Continue Shopping
            </Button>
          </div>
        )}
